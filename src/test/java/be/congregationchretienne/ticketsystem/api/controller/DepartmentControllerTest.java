...
class DepartmentControllerTest {
    ...
    void getDepartment() {
        ...
        //given
        //when
        when(departmentService.get("51f63edd-4e99-45b9-922e-fc922cf0e05f")).thenReturn(expectedDepartment);
    ...
    void getAllDepartments() {
        ...
        ResponseEntity<Object> response = departmentController.getAllDepartments(page, pageSize, orderBy, sort);
