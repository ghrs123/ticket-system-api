...
class TicketControllerTest {
    ...
    void setUp() {
        ...
        expectedTicket = new TicketDTO(
                "Ticket1", "Description", "1236454",
                PriorityDTO.MEDIUM, assignedTo, department, category,
                3, startDate, resolvedOn, StatusDTO.COMPLETE, createdBy);
        ...
        tickets = Arrays.asList(
                new TicketDTO("Ticket1", "Description", "1236454",
                        PriorityDTO.MEDIUM, assignedTo, department, category,
                        3, startDate, resolvedOn, StatusDTO.COMPLETE, createdBy),
                new TicketDTO(
                        "Ticket1", "Description", "1236454",
